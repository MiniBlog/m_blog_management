...
public class MenuController {
	...
	@PostMapping("/menu.do")
	public void ajaxAddMenu(TMbMenu menu, HttpServletResponse response) {
	...
	@PutMapping("/menu.do")
	public void ajaxModifyMenu(TMbMenu menu, HttpServletRequest request, HttpServletResponse response) {
