...
public class LogController {
	...
	public ModelAndView requestList() {
		logger.info("**************** LogController,requestList:start ****************");
		logger.info("**************** LogController,requestList:end ****************");
	...
	public void ajaxGetRequestLogList(HttpServletRequest request, HttpServletResponse response) {
		logger.info("**************** LogController,ajaxGetRequestLogList:start ****************");
		...
		try {
			...
			e.printStackTrace();
			logger.error("LogController,ajaxGetRequestLogList", e);
			aj.setSuccess(false);
			aj.setMsg(e.getMessage());
		}
		HttpServletUtil.ajaxResponse(response, aj);
		logger.info("**************** LogController,ajaxGetRequestLogList:end ****************");
	}
}
